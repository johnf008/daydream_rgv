<script lang="ts">
	...
	function updateAirplanePosition() {
		...
		const speedLimitedDifference =
			Math.sign(targetDifference) * Math.min(Math.abs(targetDifference), maxSpeed);
...
>
	...
	<div
		class="absolute top-0 left-0 w-full h-full bg-[url(/buildings-back.png)] bg-no-repeat bg-contain pointer-events-none lg:-translate-y-15"
	></div>
	<div
		class="absolute top-0 left-0 w-full h-full bg-[url(/buildings-front.png)] bg-no-repeat bg-contain pointer-events-none lg:-translate-y-15"
	></div>
	<!-- brush texture clipped to buildings -->
	<div
		class="absolute top-0 left-0 w-full h-full bg-[url('brushstroking.png')] bg-size-[100vw_100vh] bg-repeat pointer-events-none opacity-100 -translate-y-15 bg-center mix-blend-overlay"
		style="mask-image: url('/buildings-top.png'); mask-size: contain; mask-repeat: no-repeat; mask-position: center top; -webkit-mask-image: url('/buildings-top.png'); -webkit-mask-size: contain; -webkit-mask-repeat: no-repeat; -webkit-mask-position: center top;"
	></div>
	...
	<!-- Cloudy Background -->
	<div
		class="absolute bottom-0 left-1/2 -translate-x-1/2 w-full h-[80vh] bg-[url(/cloudy-bg.png)] opacity-30 bg-cover bg-no-repeat bg-top pointer-events-none -z-10"
	></div>
	...
	>
		...
		>
			...
			<h2 class="text-5xl font-serif italic text-[#8B4513] mb-10 relative">
				What is Daydream Rio Grande Valley?
			...
			<div class="text-[#8B4513] font-serif text-xl leading-relaxed space-y-8">
				<p>
					Daydream Rio Grande Valley is the <span
						class="font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-green-500"
						>first ever game jam
					</span> for teenagers in the valley, where you can make any game you can think of! Whether
					you want to make a 2D platformer, a 3D adventure game, or anything that’s been at the back
					of your mind, Daydream RGV is the place to make it come true!
				</p>

				<p>
					Our game jam is open to all skill levels! We will have several workshops throughout the 24
					hours, and mentors to guide you through your development journey. The only thing you’ll
					need is the passion to finish your game on time!
				</p>

				<!--
				<p class="font-bold text-2xl">Hack Club wants you to organize a hackathon.</p>

				<p>
					We want more hackers than ever from all over the world to have this life changing
					experience, and we want your help in making that happen.
				</p>

				<p>
					Sign up to organize a Daydream event in your city! All of our hackathons are teen-led. You
					do not need to have any previous experience, and Hack Club will provide you with funding
					and coaching.
				</p>

				<p>
					Our goal is to get <span class="font-bold">4,000 Hack Clubbers</span> to make projects
					they're proud of through Daydream, and we're giving out over
					<span class="font-bold">$120k in funding</span> to organizers like you!
				</p>
				-->

				<p class="text-center font-bold text-2xl mt-10 text-[#2C3E50]">
					Check out a game jam from <a
						class="underline hover:text-pink"
						target="_blank"
						href="https://www.youtube.com/watch?v=H5RPsCMl3uM">last year!</a
					>
				</p>
			</div>
		</div>
...
>
	...
	<div class="flex flex-col items-center w-max basis-1/2 max-md:basis-full max-md:w-full z-10">
		<div class="relative translate-y-8 max-md:translate-y-4">
			<img
				...
				alt=""
				class="object-contain absolute -bottom-16 -left-13 w-28 h-28"
			/>
			<img
				src="/letter-1-back.png"
				alt=""
				class="object-contain absolute -bottom-16 -left-13 w-28 h-28 -z-10"
			/>
			<div
				class="bg-[#FFF5FA] border-2 border-[#AA8B83] rounded-2xl text-xl font-serif p-6 w-56 text-center max-md:w-64 max-md:text-lg"
				data-point="1"
			>
				<span class="font-sans text-[#E472AB] font-bold text-[1.3rem] mr-1">#1:</span> Check in & find
				you team
			</div>
		</div>
	...
	>
		<div class="relative translate-y-24 max-md:translate-y-4">
			<img
				...
				alt=""
				class="object-contain absolute -bottom-16 -right-13 w-28 h-28"
			/>
			<img
				src="/letter-2-back.png"
				alt=""
				class="object-contain absolute -bottom-16 -right-13 w-28 h-28 -z-10"
			/>
			<div
				class="bg-[#FFF5FA] border-2 border-[#AA8B83] rounded-2xl text-xl font-serif p-6 w-56 text-center max-md:w-64 max-md:text-lg"
				data-point="2"
			>
				<span class="font-sans text-[#639DEB] font-bold text-[1.3rem] mr-1">#2:</span> Attend workshops
				to learn new skills
			</div>
		</div>
	...
	>
		<div class="relative translate-y-8 max-md:translate-y-4">
			<img
				...
				alt=""
				class="object-contain absolute -bottom-18 left-24 w-28 h-28"
			/>
			<img
				src="/letter-3-back.png"
				alt=""
				class="object-contain absolute -bottom-18 left-24 w-28 h-28 -z-10"
			/>
			<div
				class="bg-[#FFF5FA] border-2 border-[#AA8B83] rounded-2xl text-xl font-serif p-6 w-56 text-center max-md:w-64 max-md:text-lg"
				data-point="3"
			>
				<span class="font-sans text-[#AB68E2] font-bold text-[1.3rem] mr-1">#3:</span> Code your game
				with your team
			</div>
		</div>
	...
	>
		<div class="relative translate-y-24 max-md:translate-y-4">
			...
			<div
				...
				data-point="4"
			>
				<span class="font-sans text-[#F2993E] font-bold text-[1.3rem] mr-1">#4:</span> Submit and demo
				your game to win prizes
			</div>
		</div>
	...
	>
		<div class="relative">
			<div
				class="bg-[url('/card-final.png')] bg-contain bg-no-repeat bg-center text-2xl font-serif pt-24 px-8 w-128 h-96 text-center max-md:w-80 max-md:h-80 max-md:text-xl max-md:pt-16"
				data-point="5"
			>
				<span class="font-sans text-[#F2CC32] font-bold text-[1.5rem] mr-1">#5:</span> Connect with the
				Hack Club community!
			</div>
		</div>
	</div>
...
>
	<div class="max-md:absolute max-md:left-1/2 max-md:-translate-x-1/2 max-md:z-100 max-sm:pt-16">
		<div class="relative w-full max-w-3xl mx-auto min-w-72 max-md:mx-0">
			<img
				src="banner.png"
				alt="100 Cities Worldwide"
				class="absolute top-0 left-1/2 -translate-x-1/2 max-md:-translate-y-1/2 max-sm:translate-y-[calc(-50%-4rem)] h-48 w-auto z-100 scale-150 saturate-70 brightness-110 object-contain px-4 pointer-events-none"
			/>
			<img
				src="hole.png"
				alt=""
			...
			>
				All daydream events are organized by high school students like yourself! <br />
				<span class="font-bold"
					><a class="underline hover:text-pink" href="https://forms.hackclub.com/daydream"
						>Sign up</a
					> to organize now!</span
				>
			</p>
		</div>
	</div>
...
>
	...
	<div class="grid grid-cols-2 gap-8 max-w-6xl px-8 z-10 max-[900px]:grid-cols-1 max-md:gap-16">
		...
		<div class="relative transform rotate-1">
			...
			>
				<h3 class="text-xl font-serif font-bold mb-4 max-lg:mb-0 max-md:text-base">
					Where will Daydream RGV be held?
				</h3>
				<p class="text-sm">
					Daydream RGV will be held within the Rio Grande Valley. Exact location details will be
					shared to registered participants
				</p>
			</div>
		</div>
		...
		<div class="relative transform -rotate-2">
			...
			>
				...
				<p class="text-sm">
					We're here to help! Your parents can reach out to us at daydream@hackclub.com for
					questions.
				</p>
			</div>
		</div>
